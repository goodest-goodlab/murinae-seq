...
samtools index /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/06-Map/Uromys-caudimaculatus/Uromys-caudimaculatus.bam
samtools depth /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/06-Map/Uromys-caudimaculatus/Uromys-caudimaculatus.bam > /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/06-Map/Uromys-caudimaculatus/Uromys-caudimaculatus-depth.tab
#

samtools stats -d -r /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/05-Scaffolds/Uromys-caudimaculatus/Uromys-caudimaculatus.fa /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/06-Map/Uromys-caudimaculatus/Uromys-caudimaculatus.bam > /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/06-Map/Uromys-caudimaculatus/Uromys-caudimaculatus-stats.txt
samtools flagstat /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/06-Map/Uromys-caudimaculatus/Uromys-caudimaculatus.bam > /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/06-Map/Uromys-caudimaculatus/Uromys-caudimaculatus-flagstats.txt
