...
def genDedupCmd(dedup_path, sfiles, r, baselogfile, step, prev_step, int_step):
    cmd_list = [];
    cmd_num = 0;
    #print(sfiles);
    for f in sfiles:
        ...
        # Single end runs
            ...
            dedup_cmd = dedup_path + " -Xmx30g t=1 in1=" + f[0] + "," + f[1] + " ordered=t overwrite=true minidentity=100 out=" + fint;
            cmd_num += 1;
            logfile = baselogfile + "-" + str(cmd_num) + ".log";
            dedup_cmd += " &> " + logfile;
            cmd_list.append(dedup_cmd);
    ...
    for s in spec:
        ...
        for r in runtype:
            ...
            if seqfiles:
                ...
                dedup_cmds += genDedupCmd(args.path, seqfiles, r, base_logfile, step, prev_step, int_step); 
