...
def genDedupCmd(dedup_path, sfiles, r, baselogfile, step, prev_step):
    cmd_list = [];
    cmd_num = 0;
    #print(sfiles);
    for f in sfiles:
...
parser.add_argument("-p", dest="path", help="The path to dedup.sh. Default: dedup.sh", default="dedup.sh");
    ...
    for s in spec:
        ...
        for r in runtype:
            ...
            if seqfiles:
                ...
                dedup_cmds = genDedupCmd(args.path, seqfiles, r, base_logfile, step, prev_step); 
            ...
            if s_mod in ["Rattus-exulans", "Rattus-hoffmanni"]:
                ...
                if seqfiles:
                    ...
                    dedup_cmds_2 = genDedupCmd(args.path, seqfiles, r, base_logfile, step, prev_step);
