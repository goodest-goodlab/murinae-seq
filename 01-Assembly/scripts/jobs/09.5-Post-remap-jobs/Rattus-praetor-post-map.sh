...
samtools index /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/09-Remap/Rattus-praetor/Rattus-praetor.bam
samtools depth /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/09-Remap/Rattus-praetor/Rattus-praetor.bam > /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/09-Remap/Rattus-praetor/Rattus-praetor-depth.tab
#

samtools stats -d -r /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/08-Referee/Rattus-praetor/Rattus-praetor-referee-corrected.fa /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/09-Remap/Rattus-praetor/Rattus-praetor.bam > /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/09-Remap/Rattus-praetor/Rattus-praetor-stats.txt
samtools flagstat /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/09-Remap/Rattus-praetor/Rattus-praetor.bam > /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/09-Remap/Rattus-praetor/Rattus-praetor-flagstats.txt
mosdepth -x /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/09-Remap/Rattus-praetor/Rattus-praetor /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-data/09-Remap/Rattus-praetor/Rattus-praetor.bam &> /mnt/beegfs/gt156213e/murinae-seq/01-Assembly-scripts/logs/09.5-Post-remap-logs/Rattus-praetor-mosdepth.log
#
