...
# sequencing run using the base corrected assembly.
############################################################
...
############################################################
# Functions
def genBWACmd(bwa_path, sfiles, r, run_string, spec, outdir, baselogfile, ref, cmd_num):
    cmd_list = [];
    ...
    for s in specs:
        ...
        for run_ind in range(len(runtype)):
            ...
            if seqfiles:
                ...
                cur_bwa_cmds, cmd_num = genBWACmd(args.path, seqfiles, r, run_string, s_mod, run_dir, base_logfile, ref, cmd_num);
                bwa_cmds += cur_bwa_cmds
