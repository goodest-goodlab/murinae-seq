...
# Generating the commands in the job file.
    ...
    mouse_target_dir = "../Targets/mm10-protein-target-seqs/";

    for query_dir in os.listdir(args.input):
        ...
        cur_outfile = os.path.join(args.output, base_input + "-exonerate.gff");
        ...
        exonerate_cmd = "exonerate --model protein2genome --showalignment FALSE --showvulgar FALSE --showtargetgff -q " + query_file + " -t " + cur_indir + " &> " + cur_outfile;
...
#             outfile.write(exonerate_cmd + "\n");
#         core.PWS("# " + spec + " : protein not found : " + str(num_skipped), outfile);
