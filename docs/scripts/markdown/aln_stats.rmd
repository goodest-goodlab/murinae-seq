...
targets_exonerate = read.csv("../../data/aln-stats/targets-exonerate-f0.csv", header=T)
...
sample_targets_exonerate = read.csv("../../data/aln-stats/sample-targets-exonerate-f0.csv", header=T)
## HEADERS ARE OFF
...
aln_data = read.csv("../../data/aln-filters/aln-stats-f175-seq20-site50.tab", header=T, sep="\t", comment.char="#")
...
pre_sites = select(aln_data, align, pre.gappy.sites)
pre_sites$label = "Pre-filter"
names(pre_sites)[2] = "perc.sites"

post_sites = select(aln_data, align, post.gappy.sites)
