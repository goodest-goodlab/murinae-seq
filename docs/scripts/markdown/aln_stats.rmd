...
num_seqs = rbind(pre_seqs_150, post_seqs_150, pre_seqs_175, post_seqs_175)

num_seqs$label = factor(num_seqs$label, levels=c("Pre-filter (150)", "Post-filter (150)", "Pre-filter (175)", "Post-filter (175)"))
...
aln_seqs = ggplot(num_seqs, aes(x=label, y=num.seqs, fill=label)) +
  ...
  xlab("") +
  scale_fill_manual(labels=c("Pre-filter (150)", "Post-filter (150)", "Pre-filter (175)", "Post-filter (175)"), values=filter_col) +
  scale_x_discrete(labels=c("Pre-filter (150)", "Post-filter (150)", "Pre-filter (175)", "Post-filter (175)")) +
...
num_seqs = rbind(pre_seqs_150, post_seqs_150, pre_seqs_175, post_seqs_175, gbe_seqs)
num_seqs = subset(num_seqs, aln.len <= 1000)

num_seqs$label = factor(num_seqs$label, levels=c("Pre-filter (150)", "Post-filter (150)", "Pre-filter (175)", "Post-filter (175)", "GBE"))
...
aln_len = ggplot(num_seqs, aes(x=label, y=aln.len, fill=label)) +
  ...
  xlab("") +
  scale_fill_manual(labels=c("Pre-filter (150)", "Post-filter (150)", "Pre-filter (175)", "Post-filter (175)", "GBE"), values=filter_col) +
  scale_x_discrete(labels=c("Pre-filter (150)", "Post-filter (150)", "Pre-filter (175)", "Post-filter (175)", "GBE")) +
  #scale_y_continuous(expand=c(0,0)) +
  bartheme() +
  theme(legend.position="none",
...
num_seqs = rbind(pre_seqs_150, post_seqs_150, pre_seqs_175, post_seqs_175, gbe_seqs, mus_lens)
num_seqs = subset(num_seqs, nongap.len <= 1000)

num_seqs$label = factor(num_seqs$label, levels=c("Pre-filter (150)", "Post-filter (150)", "Pre-filter (175)", "Post-filter (175)", "GBE", "Mus CDS"))
...
nongap_len = ggplot(num_seqs, aes(x=label, y=nongap.len, fill=label)) +
  ...
  xlab("") +
  scale_fill_manual(labels=c("Pre-filter (150)", "Post-filter (150)", "Pre-filter (175)", "Post-filter (175)", "GBE", "Mus CDS"), values=filter_col) +
  scale_x_discrete(labels=c("Pre-filter (150)", "Post-filter (150)", "Pre-filter (175)", "Post-filter (175)", "GBE", "Mus CDS")) +
  #scale_y_continuous(expand=c(0,0)) +
  bartheme() +
  theme(legend.position="none",
        axis.text.x=element_text(angle=45, hjust=1))
...
num_sites = rbind(pre_sites_150, post_sites_150, pre_sites_175, post_sites_175)
num_sites = subset(num_sites, perc.sites < 1000)
num_sites$label = factor(num_sites$label, levels=c("Pre-filter (150)", "Post-filter (150)", "Pre-filter (175)", "Post-filter (175)"))
