...
## Branch rates compared to rates using the species tree

```{r rate-comps, out.width="50%", fig.align = "center", warning=FALSE}
...
# Substitution rates and phenotypes

```{r read-pheno, out.width="50%", fig.align = "center", warning=FALSE}
...
```{r ds-pheno, out.width="75%", fig.align = "center", warning=FALSE, fig.height=8, eval=F}
...
```{r dn-pheno, out.width="75%", fig.align = "center", warning=FALSE, fig.height=8, eval=F}
...
```{r dn-ds-pheno, out.width="75%", fig.align = "center", warning=FALSE, fig.height=8, eval=F}
...
```{r mass-anc, out.width="75%", fig.align = "center", warning=FALSE, fig.height=8, eval=F}
...
```{r mass-pic, out.width="75%", fig.align = "center", warning=FALSE, fig.height=8, eval=F}
astral_bl_tree = read.tree(file="../../data/trees/full_coding_iqtree_astral.cf.bl.nrf25.rooted.treefile")
