...
if(tree_type == "astral"){
  ...
  codon_file = "../../data/convergence/full-coding-astral-pairwise-convergence-nodesc/codons-by-branch.csv"
...
## Convergent vs. divergent substitutions 

```{r all-genes-all-branches, out.width="75%", fig.align = "center", warning=FALSE}
...
```{r mf-genes-all-branches, out.width="75%", fig.align = "center", warning=FALSE}
...
```{r all-genes-mf-branches, out.width="75%", fig.align = "center", warning=FALSE}
...
```{r mf-genes-mf-branches, out.width="75%", fig.align = "center", warning=FALSE}
...
```{r combine-gene-plots, out.width="75%", fig.align = "center", warning=FALSE}
...
```{r gene-convergence-divergence, out.width="75%", fig.align = "center", warning=FALSE}
...
# Codon usage over time

```{r read-codon-subs, out.width="75%", fig.align = "center", warning=FALSE}

codons_by_branch = read.csv(codon_file, header=T)
tree_info = merge(tree_info, codons_by_branch, by='clade')
