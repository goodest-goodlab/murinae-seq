...
scaff_p = ggpaired(in_data, x="Assembly", y="No_scaffolds",
...
len_p = ggpaired(in_data, x="Assembly", y="Mean_Len",
         fill="Assembly", palette=corecol(pal="trek", numcol=2), color="#333333",
         line.color="#b3b3b3", line.size = 0.4,
         width=0.4, point.size=2,
...
### Coding targets and target lengths

```{r fig6, out.width="100%", fig.align="center", warning=FALSE}
####################
# Spades Australian assembly comparisons

scaff_p = ggpaired(in_data, x="Assembly", y="codingTargets",
                 fill="Assembly", palette=corecol(pal="trek", numcol=2), color="#333333",
                 line.color="#b3b3b3", line.size = 0.4,
                 width=0.4, point.size=2,
...
len_p = ggpaired(in_data, x="Assembly", y="coding_meanLen",
         fill="Assembly", palette=corecol(pal="trek", numcol=2), color="#333333",
         line.color="#b3b3b3", line.size = 0.4,
         width=0.4, point.size=2,
