...
if(tree_type == "astral"){
  ...
  branch_rates_file_arid = "../../data/rates/full-coding-astral-slac-branch-rates-arid.csv"
  branch_rates_file_mf = "../../data/rates/full-coding-astral-slac-branch-rates-morphofacial.csv"
...
```{r bl-v-cf, out.width="75%", fig.align = "center", warning=FALSE}
