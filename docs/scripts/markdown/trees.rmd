...
rate_tree = ggtree(rodent_tree, size=0.8, ladderize=F, aes(color=log(tree_rates$dS))) +
  scale_color_continuous(name='dS', low=l, high=h) +
  xlim(0, xmax) +
  geom_tiplab(color="#333333", fontface='italic', size=2) +
  theme(legend.position=c(0.05,0.9)) +
...
rate_tree = ggtree(rodent_tree, size=0.8, ladderize=F, aes(color=log(tree_rates$dN))) +
...
rate_tree = ggtree(rodent_tree, size=0.8, ladderize=F, aes(color=log(tree_rates$dNdS))) +
...
p = ggplot(pheno_rates_long, aes(x=value, y=log(dS))) +
  geom_point(size=2, alpha=0.2, color="#333333") +
...
p = ggplot(pheno_rates_long, aes(x=value, y=log(dN))) +
  geom_point(size=2, alpha=0.2, color="#333333") +
  geom_smooth(method="lm", se=F, linetype="dashed", color=corecol(numcol=1, pal="wilke", offset=2)) +
  xlab("Avg. trait value per tip") +
  ylab("dN per tip") +
...
p = ggplot(pheno_rates_long, aes(x=value, y=log(dNdS))) +
  geom_point(size=2, alpha=0.2, color="#333333") +
  geom_smooth(method="lm", se=F, linetype="dashed", color=corecol(numcol=1, pal="wilke", offset=2)) +
  xlab("Avg. trait value per tip") +
  ylab("dN/dS per tip") +
