...
p = ggplot(tree2_internal_info, aes(x=delta.recon, y=node)) +
  geom_point(aes(color="Inferred (95% CI)"), size=2, alpha=0.7) +
  ...
  scale_color_manual(values=c("Inferred (95% CI)"="black", "Observed"="red")) +
  xlab("Delta") +
  ylab("Node") +
  bartheme() +
...
```
## Speciation rates based on Tribe sampling and delta
