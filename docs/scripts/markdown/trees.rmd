...
if(tree_type == "astral"){
  ...
  cat("188 species.\n11,775 coding loci.\nGene trees inferred with IQtree.\nSpecies tree inferred with by concatenation of all loci with IQtree.\n")
}
...
```{r fig9, out.width="100%", fig.align = "center", warning=FALSE, fig.height=16}
h = corecol(numcol=1, pal="wilke", offset=1)
l = corecol(numcol=1, offset=1)
...
```{r fig11, out.width="75%", fig.align = "center", warning=FALSE, fig.height=8}
