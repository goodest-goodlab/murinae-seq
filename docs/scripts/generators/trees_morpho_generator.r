...
# This generates the file "trees-morpho.html"
############################################################

#options(nwarnings = 100000)
#tree_type = "astral"

cat("Rendering trees-morpho.rmd/html\n", sep="")
...
output_file = paste("trees-morpho.html", sep="")

render("../markdown/trees_morpho.rmd", output_dir = output_dir, output_file = output_file, params = list(output_dir = output_dir, output_file = output_file, tree_type = tree_type), quiet = TRUE)
# Knit the html page
