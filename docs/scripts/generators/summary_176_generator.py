...
# This generates the file "summary-176.html"
############################################################
		...
		<div class="pure-u-22-24" id="main_col">
			<div id="main_content">
                ...
                <div id="node_links_cont">
                    ...
                    <p><h4><a href="assembly_stats_2.html">Assembly with Spades</a></h4></p>
...
# Main block
######################
pagefile = "summary_176.html";
print("Generating " + pagefile + "...");
title = "176 exome summary"

head = RC.readHead(title);
nav = RC.readNav(pagefile);
footer = RC.readFooter();

page_title = "Summary of 176 exome samples"
