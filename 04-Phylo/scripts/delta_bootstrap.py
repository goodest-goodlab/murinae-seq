...
species_tree = "../04-Phylo/full-coding-iqtree/astral/astral-rooted.out";
gene_tree_file = "../04-Phylo/full-coding-iqtree/loci.treefile";
outdir = "../04-Phylo/full-coding-iqtree/astral/concord-rooted/cf-reps/";
overwrite = True;

if not os.path.isdir(outdir):
    os.system("mkdir " + outdir);
elif not overwrite:
    sys.exit(" * ERROR: output directory exists. Set overwrite and re-run to continue.");
...
for i in range(0,1000):
    ...
    iqtree_cmd = "iqtree -t " + species_tree + " --gcf " + cur_gt_file + " --df-tree --cf-verbose --prefix " + prefix + " -T 62";
    print(iqtree_cmd);
